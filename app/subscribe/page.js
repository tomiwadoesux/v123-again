              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    className="w-full bg-transparent border border-black px-3 py-2 pr-8 focus:outline-none focus:ring-1 focus:ring-accent text-sm font-roboto appearance-none rounded-none"
                  >
                    {categories.map((cat) => (
